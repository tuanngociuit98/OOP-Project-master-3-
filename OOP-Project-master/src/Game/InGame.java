...
public class InGame extends BasicGameState{
	...
	public void display() throws SlickException, InterruptedException
	{
		drawCandy=new DrawCandy();
	}
	
	public void Falling() throws SlickException, InterruptedException {
		boolean rp = false;
		for(int i = 0; i < lengthColum; i++) {
			for(int j = 0; j < lengthRow; j++) {
				if(matrix2d.MT[i][j].typeCandy != 10) {
...
//		}
	...
	public void getnewcandy() throws InterruptedException, SlickException
	{
		for(int i = 0; i < lengthColum; i++) {
			for(int j = 0; j < lengthRow; j++) {
				if(matrix2d.MT[i][j].typeCandy == 10) {
